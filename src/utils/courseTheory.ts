...
const COURSE_DEFINITIONS: Array<Omit<TheoryChapter, "difficulties"> & { difficultySeeds: Record<TheoryDifficultyId, { badge: string; description: string; questions: QuestionSeed[] }> }> = [
  {
    ...
    difficultySeeds: {
      ...
      hell: {
        ...
        questions: [
          q("Cmaj7 六弦系统", "Cmaj7 如果用六弦根音系统，根音在哪？ghost note 更自然拍哪根弦？", "根音与落点", "6弦8品，拍6弦", ["六弦8品拍六弦", "6弦8品拍6弦", "8品6弦", "6-8 string6", "string6 fret8 string6"], "右手落点", ["先找根音，再决定右手落点。"], ["六弦根音 C 在 8 品，所以 ghost note 更自然落在六弦区域。"]),
          q("Dm9 五弦系统", "Dm9 常用五弦根音系统时，根音在哪？ghost note 更自然拍哪根弦？", "根音与落点", "5弦5品，拍5弦", ["五弦5品拍五弦", "5弦5品拍5弦", "5-5 string5", "string5 fret5 string5"], "右手落点", ["D 在 5 弦 5 品。"], ["五弦根音 D 在 5 品，所以 ghost note 更自然落在五弦区域。"]),
          q("G7 六弦系统", "G7 如果用六弦根音系统，根音在哪？ghost note 更自然拍哪根弦？", "根音与落点", "6弦3品，拍6弦", ["六弦3品拍六弦", "6弦3品拍6弦", "3品6弦", "6-3 string6", "string6 fret3 string6"], "右手落点", ["6 弦开放音 E，1 品 F，3 品 G。"], ["六弦根音 G 在 3 品，所以 ghost note 更自然落在六弦区域。"]),
        ],
      },
    },
  },
  {
    ...
    difficultySeeds: {
      ...
      hell: {
        ...
        questions: [...DIATONIC_SPECIAL_QUESTIONS, buildAuthenticCadenceQuestion()],
      },
    },
  },
  {
    ...
    difficultySeeds: {
      easy: {
        ...
        questions: [
          q("C", "没有后缀的 C 通常表示什么和弦类型？", "类型", "大三和弦", ["major", "大三", "C大三和弦"], "三和弦标记", ["没有 m、dim、aug 等后缀时，通常默认为大三和弦。"], ["C 通常表示 C 大三和弦，也就是 C E G。"], ["大三和弦", "小三和弦", "减三和弦", "增三和弦"]),
      ...
      medium: {
        ...
        questions: [
          q("Cmaj7", "Cmaj7 / C△7 表示什么和弦类型？", "类型", "大七", ["major7", "大七和弦", "maj7"], "七和弦标记", ["maj7、M7、△7 都指 major seventh。"], ["Cmaj7 是 C 大七和弦，不是 C7。"], ["大七", "属七", "小七", "半减七"]),
          q("C7", "C7 表示大七还是属七？", "类型", "属七", ["dominant7", "dom7", "属七和弦"], "七和弦标记", ["只有根音 + 7 默认是属七。"], ["C7 是 C 属七，不是 Cmaj7。"], ["大七", "属七", "小七", "半减七"]),
          q("Cm7", "Cm7 / C-7 表示什么和弦类型？", "类型", "小七", ["minor7", "小七和弦", "m7"], "七和弦标记", ["m、min、- 都和 minor 相关。"], ["Cm7 和 C-7 都表示 C 小七和弦。"], ["大七", "属七", "小七", "半减七"]),
      ...
      hell: {
        ...
        questions: [
          ...
          q("C-7", "C-7 / Cmin7 / Cm7 都表示什么？", "类型", "小七和弦", ["m7", "minor7", "小七"], "多写法", ["减号在和弦标记里常表示 minor，不是把某个音降半音。"], ["C-7、Cmin7、Cm7 都是 C 小七和弦。"], ["小七和弦", "大七和弦", "属七和弦", "减七和弦"]),
          q("C°7", "C°7 / Cdim7 表示什么？", "类型", "减七和弦", ["dim7", "diminished7", "减七"], "多写法", ["°7 是 fully diminished seventh，不是 ø7。"], ["C°7 和 Cdim7 表示 C 减七和弦；Cø7 才是半减七。"], ["减七和弦", "半减七和弦", "属七和弦", "小七和弦"]),
        ],
      },
    },
  },
    ...
    difficultySeeds: {
      ...
      medium: {
        ...
        questions: [
          ...
          q("G9", "G9 的完整和弦音是什么？", "音名", "G B D F A", ["G,B,D,F,A", "G B D F A"], "属九结构", ["G9 = G7 + 9；属七的七音是 b7。"], ["G9 完整结构是 G B D F A：1、3、5、b7、9。"]),
      ...
      hard: {
        ...
        questions: [
          ...
          q("属和弦自然11", "G11/G13 这类属和弦里，自然 11 为什么常被省略？", "原因", "11音与3音形成小九度冲突", ["11和3冲突", "C和B冲突", "与3音b9冲突", "小九度冲突", "b9 clash", "11 3 clash", "C B clash"], "属和弦 11 省略", ["G 的 3 音是 B，自然 11 是 C。"], ["在 G 属和弦里，3 音 B 和自然 11 音 C 相差小二度/小九度，容易和属和弦的三音功能打架，所以实际 voicing 常省略自然 11，或改成 sus4。"]),
        ],
      },
      hell: {
        badge: "声部解决",
        ...
        questions: [
          ...
          q("G7(b13) 到 G13", "G7(b13) -> G13 中哪个音上行半音？", "声部", "Eb -> E", ["Eb到E", "Eb-E", "b13到13"], "变化延伸音", ["G 的 b13 是 Eb，自然 13 是 E。"], ["G7(b13) 到 G13 是 Eb -> E，相当于把暗色的 b13 还原成自然 13。"]),
        ],
      },
    },
  },
    ...
    difficultySeeds: {
      easy: {
        ...
        questions: [
          ...
          q("G7", "G7 属于 C major 顺阶七和弦吗？", "判断", "属于", ["是", "属于", "在C大调"], "C 内外", ["C major 的 5 级七和弦是 G7。"], ["G7 属于 C major，是 V7。"], ["属于", "不属于"]),
          q("Abmaj7", "Abmaj7 属于 C major 顺阶和弦吗？", "判断", "不属于", ["不是", "否", "不在C大调"], "C 内外", ["C major 没有 Ab。"], ["Abmaj7 不属于 C major，常可借自 C minor 的 bVImaj7。"], ["属于", "不属于"]),
        ],
      },
      medium: {
        badge: "C minor 借用",
    ...
    difficultySeeds: {
      easy: {
        ...
        questions: [
          ...
          q("一拍的 16 分格", "4/4 里一拍有几个 16 分音符格？", "数量", "4", ["4个", "四个"], "16 分网格", ["一拍四等分，就是 1 e & a。"], ["一拍有 4 个 16 分音符格；四拍合起来才是 16 格。"]),
      ...
      hard: {
        ...
        questions: [
          ...
          q("ghost note 落点", "五弦根音系统里，ghost note 更自然拍哪根弦的区域？", "弦区", "5弦", ["五弦", "5弦", "五弦区域", "5", "string5"], "ghost note 落点", ["老师反复强调：根音系统决定右手落点。"], ["五弦根音系统里，ghost note 更自然落在五弦区域；六弦根音系统则更自然落在六弦区域。"]),
        ],
      },
      hell: {
        badge: "能否回到第一拍",
        ...
        questions: [
          ...
          q("六六四分组", "6+6+4 能在一小节末回到下一小节第一拍吗？", "判断", "能", ["可以", "能回到one", "能"], "回到第一拍", ["6 + 6 + 4 = 16。"], ["6+6+4 正好等于 16 个十六分音符，所以能回到下一小节第一拍（one）。"], ["能", "不能"]),
          q("五组三音", "如果一小节只排 3+3+3+3+3，会不会完整回到下一小节第一拍？", "判断", "不能", ["不会", "不能回到one", "不能"], "回到第一拍", ["总数只有 15。"], ["3+3+3+3+3 只有 15 格，少 1 格，不能完整回到下一小节第一拍。"], ["能", "不能"]),
          q("六六六分组", "如果一小节排 6+6+6，会不会完整回到下一小节第一拍？", "判断", "不能", ["不会", "不能回到one", "不能"], "回到第一拍", ["6 + 6 + 6 = 18，超过一小节 16 格。"], ["6+6+6 会跨过一小节 16 格，不能在本小节末准确回到下一小节第一拍。"], ["能", "不能"]),
        ],
      },
    },
  },
...
function buildAuthenticCadenceQuestion(): QuestionSeed {
  return q(
    "G7-Cmaj7",
    "G7 - Cmaj7 在 C 大调里用罗马数字怎样分析？",
    "级数进行",
    "V7 - Imaj7",
    ["V7 Imaj7", "V7-Imaj7", "5-1", "五级到一级"],
    "属到主解决",
...
function buildHarmonicMinorReasonQuestions(minorRoots: string[]): QuestionSeed[] {
  return minorRoots.map((minorRoot) => {
    ...
    return q(
      ...
      "原因",
      "制造导音让V7更强地回到i",
      ["制造导音", `让${dominantRoot}7回${minorRoot}m更强`, "形成V7回i", "导音回主音", "leading tone", "V7 to i", "stronger V7 i"],
      "和声小调功能",
