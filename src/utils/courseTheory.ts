    ...
    difficultySeeds: {
      ...
      hell: {
        ...
        questions: [
          ...
          q("G7 六弦系统", "G7 如果用六弦根音系统，根音在哪？ghost note 更自然拍哪根弦？", "根音与落点", "6弦3品，拍6弦", ["六弦3品拍六弦", "6弦3品拍6弦", "3品6弦"], "右手落点", ["6 弦开放音 E，1 品 F，3 品 G。"], ["六弦根音 G 在 3 品，所以 ghost note 更自然落在六弦区域。"]),
        ],
      },
    },
  },
    ...
    difficultySeeds: {
      ...
      medium: {
        ...
        questions: [
          ...
          q("X...X...X...X...", "X...X...X...X... 表示哪种 16 格重音？", "分组", "每拍一个重音", ["四分音符重音", "1拍1个", "每拍一次"], "重音位置", ["每个 X 后面 3 个点，说明每 4 个 16 分格一个重音。"], ["X...X...X...X... 的重音落在 1、5、9、13 格，也就是每拍一个重音。"]),
