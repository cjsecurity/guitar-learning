...
| 模块 | 覆盖范围 | 审校结论 |
| --- | --- | --- |
| 音程距离速算 | P1、m2、M2、m3、M3、P4、A4、d5、P5、m6、M6、m7、M7、P8 | 度数按字母，性质按半音；A4/d5 区分等音异名；B -> E# 这类题首句解释不能直接写成 F；基础协和分类保留纯四度为完全协和。C 根音含升降号、自然根音随机、反向拼写都判定度数、半音、完整音程名、基础协和分类；后两档额外要求目标音。 |
...
| Cmaj7 六弦系统 / Dm9 五弦系统 / G7 六弦系统 | 吉他根音系统与右手落点 | 通过，属于课程演奏技术，不伪装成通用和声概念 |
...
| Bm7b5-E7-Am7 / Dm7-G7-Cmaj7 / G7-Cmaj7 | 副属和弦 / applied chord；ii-V-I；属到主解决 | 通过，标准写法为 viiø7 - V7/vi - vi7；同时接受 viio7、vii07、viim7b5 等可打字写法 |
| C / Cm / Cdim / Caug | 三和弦标记 | 通过，已改为选择题优先 |
| Cmaj7 / C7 / Cm7 / Cø7 / Cdim7 | 大七、属七、小七、半减七、减七标记 | 通过，Cdim7 与 Cm7b5 区分为不同和弦 |
| G13sus4 / G7(b13) / Cadd9 vs C9 / C6 vs C13 / Csus2 / C/E | sus、变化延伸音、add9、六和弦、slash chord | 通过 |
| Bø7 / C△7 / C-7 / C°7 | 和弦符号多写法 | 通过，综合档也改为选择题，避免依赖自由文本同义词匹配 |
| 9 的来源 / 11 的来源 / 13 的来源 | 延伸音 2->9、4->11、6->13 | 通过 |
| Dm9 / G9 | 九和弦完整结构 | 通过，强调 D F C E 是 Dm9(no5)，并覆盖属九 G9 的完整 1-3-5-b7-9 结构 |
...
| G13sus4 到 G13 / G13 到 G7(b13) / G7(b13) 到 G13 | sus 解决与 13、b13 的声部变化 | 通过 |
...
| Ebmaj7 / Fmaj7 / G7 / Abmaj7 | C major 内外判断 | 通过 |
...
| 4/4 的 16 分格 / 一拍的 16 分格 / 每拍口令 | 十六分音符细分 | 通过 |
| X..X..X..X..X... / X...X...X...X... | 3+3+3+3+4 的 16 格重音移位；每拍一个重音基准 | 通过，长度 16，错位重音与常规四拍重音可对比 |
...
| 四组三音加四格 / 六六四分组 / 五组三音 / 六六六分组 | 是否回到下一小节第一拍 | 通过，覆盖正好 16 格、少于 16 格、超过 16 格三类判断 |
...
- 高风险行为会做运行时断言：D#maj9 的严格拼写与 Ebmaj9 提示、F -> D 的上行大六度音频、`viio7` 可打字罗马数字、全中文弦品答案归一化。
- 反馈徽章必须区分“作答判题”和“复盘参考”：隐藏字段、未要求填写的音程字段、和弦公式等系统补充信息不能显示为“正确”。
- 所有理论课程难度至少保留 3 题，避免学生反复抽到同一两道题却误以为已经掌握。
