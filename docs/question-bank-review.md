...
| A小调 v7 / A小调 V7 / A小调 vii°7 / 为何升7级 | 自然小调 v7、和声小调属七、导音减七与导音功能 | 通过 |
...
| 排出 3+3+3+3+4 / 排出 3+3+2+3+3+2 / ghost note 落点 | 16 格 pattern 输入；右手弦区 | 通过，标准答案为 X..X..X..X..X...；补充五弦根音系统的 ghost note 弦区 |
